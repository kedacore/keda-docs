...
- `activationQueryValue` - Target value for activating the scaler. Learn more about activation [here](./reference/scaledobject-spec#activating-and-scaling-thresholds).(Default: `0`, Optional, This value can be a float)
