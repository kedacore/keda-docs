...
3. You can also view the logs of individual KEDA components (e.g., scalers, metrics adapters) by running:

   ```bash
   kubectl logs -n keda -l app=<component-name>
   ```

   Replace `<component-name>` with the name of the KEDA component you want to inspect (e.g., `keda-metrics-apiserver`).
