...
- `metricName` - Name to assign to the metric. If not set KEDA will generate a name based on either the connection string if set or the db name. If using more than one trigger it is required that all metricNames be unique. (DEPRECATED: This parameter will be removed in version `2.12`, don't set it)
...
- type: postgresql
  metadata:
    ...
    metricName: backlog_process_count # DEPRECATED: This parameter will be removed in version 2.12, don't set it. optional. Generated value would be `postgresql-postgresql---test@localhost`
```
...
- type: postgresql
  metadata:
    ...
    metricName: backlog_process_count # DEPRECATED: This parameter will be removed in version `2.12`, don't set it. optional. Generated value would be `postgresql-test_db_name`
```
