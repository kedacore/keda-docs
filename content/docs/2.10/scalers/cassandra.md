...
triggers:
  - type: cassandra
    metadata:
      ...
      metricName: "test_keyspace" # DEPRECATED: This parameter will be removed in version 2.12, don't set it
```
...
- `metricName` - Name to assign to the metric. (DEPRECATED: This parameter will be removed in version `2.12`, don't set it. Default: `s<X>-cassandra-<KEYSPACE>`, Optional, In case of `metricName` is specified, it will be used to generate the `metricName` like this: `s<X>-cassandra-<METRICNAME>`, where `<X>` is the index of the trigger in a ScaledObject)
