...
> **Notice:** 
> - No. of replicas will not exceed the number of partitions on a topic. That is, if `maxReplicaCount` is set more than number of partition, the scaler won't scale up to target maxReplicaCount. 
