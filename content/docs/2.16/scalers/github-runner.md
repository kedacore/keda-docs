...
- `noDefaultLabels` - Not scale on default runner labels ("self-hosted", "linux", "x64"), can be either "true" or "false". (Default: "false" [scale on default runner labels])
...
- `noDefaultLabelsFromEnv` - Not scale on default runner labels ("self-hosted", "linux", "x64"), can be either "true" or "false". (Default: "false" [scale on default runner labels])
