...
- The `ScaledObject` name exceeds 54 characters. KEDA generates an HPA with the name `keda-hpa-<scaledobject-name>`, and Kubernetes requires that name to be a valid DNS label (maximum 63 characters). Since the `keda-hpa-` prefix consumes 9 characters, the `ScaledObject` name is limited to 54 characters.
